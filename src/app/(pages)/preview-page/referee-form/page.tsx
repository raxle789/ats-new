...
import { Form, Input, Select, message, DatePicker, Radio, Button } from 'antd';
                ...
                <div className="row">
                  <div className="col-12">
                    <div className="input-group-meta position-relative mb-0">
                      <label>
                        Name the company where you meet (Candidate_name)*
                      </label>
                      <Form.Item<FieldType>
                        name={['refereeCheckData', 'companyName']}
                        className="mb-3"
                        rules={[
                          {
                            required: true,
                  ...
                  <div className="col-12">
                    <div className="input-group-meta position-relative mb-0">
                      ...
                      <Form.Item<FieldType>
                        name={['refereeCheckData', 'introductionDate']}
                        className="mb-3"
                        rules={[
                          {
                            required: true,
                  ...
                  <div className="col-12">
                    <div className="input-group-meta position-relative mb-0">
                      ...
                      <Form.Item<FieldType>
                        name={['refereeCheckData', 'durationWithReferee']}
                        className="mb-3"
                        rules={[
                          {
                            required: true,
                  ...
                  <div className="col-12">
                    <div className="input-group-meta position-relative mb-0">
                      ...
                      <Form.Item<FieldType>
                        name={['refereeCheckData', 'relation']}
                        className="mb-3"
                        rules={[
                          {
                            required: true,
                  ...
                  <div className="col-12">
                    <div className="input-group-meta position-relative mb-0">
                      <label>
                        What is position name of (Candidate_name) when you
                        working together?*
                      </label>
                      <div className="row">
                        <div className="col-1">
                          <Form.Item<FieldType>
                            name={['refereeCheckData', 'positionOption']}
                            className="mb-3"
                            rules={[
                              {
                                required: true,
                        ...
                        {positionOption === 'No' && (
                          <div className="col-11 ps-3">
                            <Form.Item<FieldType>
                              name={['refereeCheckData', 'position']}
                              className="mb-3"
                              rules={[
                                {
                                  required: true,
                  ...
                  <div className="col-12">
                    <div className="input-group-meta position-relative mb-0">
                      <label>
                        Reason why (Candidate_name) left the company*
                      </label>
                      <Form.Item<FieldType>
                        name={['refereeCheckData', 'reason']}
                        className="mb-3"
                        rules={[
                          {
                            required: true,
                  ...
                  <div className="col-12">
                    <div className="input-group-meta position-relative mb-0">
                      <label>
                        Are there any ethical issues or disciplinary history or
                        ongoing issues such as sanity/manner, money,
                        solicitation, etc regarding to (Candidate_name)'s track
                        record?*
                      </label>
                      <Form.Item<FieldType>
                        name={['refereeCheckData', 'ethicalIssue']}
                        className="mb-3"
                        rules={[
                          {
                            required: true,
                  ...
                  <div className="col-12">
                    <div className="input-group-meta position-relative mb-0">
                      <label>
                        Please share the strength points of (Candidate_name)
                        comparing another team member/subordinate?
                      </label>
                      <Form.Item<FieldType>
                        name={['refereeCheckData', 'strengthPoints']}
                        className="mb-3"
                        rules={[
                          {
                            required: true,
                  ...
                  <div className="col-12">
                    <div className="input-group-meta position-relative mb-0">
                      <label>
                        Please share the area that you think (Candidate_name)
                        need to improve?
                      </label>
                      <Form.Item<FieldType>
                        name={['refereeCheckData', 'improveArea']}
                        className="mb-3"
                        rules={[
                          {
                            required: true,
                  ...
                  <div className="col-12">
                    <div className="input-group-meta position-relative mb-0">
                      <label>
                        If you have position that suitable for (Candidate_name),
                        would you consider to rehire (Candidate_name)?
                      </label>
                      <div className="row">
                        <div className="col-1">
                          <Form.Item<FieldType>
                            name={['refereeCheckData', 'considerOption']}
                            className="mb-3"
                            rules={[
                              {
                                required: true,
                        ...
                        <div className="col-11 ps-3">
                          <Form.Item<FieldType>
                            name={['refereeCheckData', 'considerReason']}
                            className="mb-3"
                            rules={[
                              {
                                required: true,
                  ...
                  <div className="col-12">
                    <div className="input-group-meta position-relative mb-0">
                      <label>
                        ...
                        to share with us related to (Candidate_name)?
                      </label>
                      <Form.Item<FieldType>
                        name={['refereeCheckData', 'additionalInformation']}
                        className="mb-3"
                        rules={[
                          {
                            required: true,
