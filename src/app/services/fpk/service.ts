...
export async function getAllFpkTotal() {
  try {
    ...
    const total =
      await prisma.$queryRaw`SELECT COUNT(*) AS total FROM MASTER_ERA.dbo.PROINT_trx_efpk`;
