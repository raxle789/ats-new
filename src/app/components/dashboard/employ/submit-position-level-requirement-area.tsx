...
import SubmitPositionLevelRequirementItem from './submit-position-level-requirement-item';
import {
...
const SubmitPositionLevelRequirementArea: React.FC<Props> = async ({
  params,
}) => {
  ...
  return (
    <>
      <SubmitPositionLevelRequirementItem
...
export default SubmitPositionLevelRequirementArea;
