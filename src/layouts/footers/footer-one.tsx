          ...
          <div className="row">
            ...
            <div className="col-lg-4 mb-20 footer-newsletter">
              ...
              <p className={`${style_2 ? 'text-white' : ''}`}>
                Erajaya Development and Assessment Center
              </p>
              {/* <form
                action="#"
              ...
              <p className="note">
                Hayam Wuruk Plaza, 19th Floor Jl. Hayam wuruk 108, Maphar Taman
                Sari West Jakarta 11240
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-4 order-lg-2">
              <p className={`text-center mb-15 ${style_2 ? 'text-white' : ''}`}>
                Copyright @{new Date().getFullYear()} Powered By Erajaya
              </p>
            </div>
          </div>
        </div>
